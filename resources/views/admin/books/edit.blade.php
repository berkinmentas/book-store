                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-6">
                        <div class="mb-5">
                            ...
                            <input type="text" id="category" name="category" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{$book->category}}">
                        </div>
                    </div>
